...
int b64_encode(const unsigned char* aInput, int aInputLen,
               unsigned char* aOutput, int aOutputLen) {
    ...
    if (aInputLen == 3) {
        ...
        if (aInputLen % 3 > 0) {
            ...
            b64_encode(&aInput[i * 3], aInputLen % 3, &aOutput[i * 4],
                    aOutputLen - (i * 4));
        }
    }
